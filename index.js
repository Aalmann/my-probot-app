...
module.exports = app => {
  ...
  app.on('issue_comment.edited', async context => {
    if (!context.isBot) {
      const params = context.issue({ body: 'You have edited one comment.' })
  ...
  app.on('issues.opened', async context => {
    ...
    const params = context.issue({ body: 'Thanks for creating this issue.\nOne of the team members will give you feedback as soon as possible.' })
